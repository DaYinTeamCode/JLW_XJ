package com.jlwteam.rebate.page.coupon.me;
...
public class MainUserFragment extends CpHttpFrameXrvFragmentViewer implements OnExRvItemViewClickListener, ExBaseWidget.OnWidgetViewClickListener {
    ...
    protected void initTitleView() {
        ...
        mTitleWidget.setTitleViewBg(new ColorDrawable(Color.TRANSPARENT), ExResUtil.getDrawable(R.drawable.shape_bg_colorful_no_corner));
