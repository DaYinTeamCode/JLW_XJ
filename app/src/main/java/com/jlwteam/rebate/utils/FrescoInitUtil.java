...
import com.androidex.imageloader.fresco.FrescoIniter;
...
/**
 * Create By DaYin(gaoyin_vip@126.com) on 2019/5/30 7:19 PM
 */
public class FrescoInitUtil {
    ...
    public static void initFrescoConfig(Context context) {
        ...
        ImagePipelineConfig pipeConfig = ImagePipelineConfig.newBuilder(context)
                .setBitmapMemoryCacheParamsSupplier(new BitmapCacheParamsSupplier(context))//bitmap内存缓存数据的策略
                ...
                //设置磁盘缓存项配置
                .setMainDiskCacheConfig(getDisCacheConfigDefault(context))
                .setSmallImageDiskCacheConfig(getDisCacheConfigSmall(context))
        ...
        FrescoIniter.initialize(context, pipeConfig);
    }
    ...
    public static class BitmapCacheParamsSupplier implements Supplier<MemoryCacheParams> {
        ...
        public BitmapCacheParamsSupplier(Context context) {
