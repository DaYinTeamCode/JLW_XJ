...
import com.jlwteam.rebate.httptask.lisn.CpHttpTaskExeListener;
import com.jlwteam.rebate.httptask.lisn.CpHttpTaskNetworkListener;
import com.jlwteam.rebate.utils.FrescoInitUtil;
...
//        initBugly();
    ...
    public static String getApkChannelName() {
        ...
        return WalleChannelReader.getChannel(XJApp.getContext(), "dev");
    }
}
